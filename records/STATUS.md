...
- Date: 2026-09-02
  - Change: cold Finder file opens now present their document window immediately while preserving restored sessions, and CI verifies the behavior with isolated recovery data
...
- Next: publish and verify `1.1.2`
  - Owner: orchestrator plus the release workflow
  - Trigger: the Finder-launch repair passes final review and local verification
