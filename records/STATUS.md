...
- Date: 2026-09-02
  - Change: the editor preserves active input-method composition and repairs font fallback after syntax highlighting
  - Why it matters: Korean and other writing systems no longer become invisible or get split apart while typing
  - Related ids: `LOG-20260902-040740-260902`
...
- Next: publish and verify `1.1.0`
  - Owner: orchestrator plus the release workflow
  - Trigger: the Korean input fix passes local verification
