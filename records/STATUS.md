...
- Current focus: keep the published `1.1.1` baseline stable while the next release accumulates
- Highest-priority blocker: none; the public `1.1.1` DMG and Sparkle update are verified
...
- Next: accumulate and verify changes for the next release
  ...
  - Trigger: accepted product work changes the published `1.1.1` baseline
