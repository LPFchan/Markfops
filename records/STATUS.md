...
- Current focus: keep the published `1.0.3` baseline stable while the next release accumulates
- Highest-priority blocker: none; the public `1.0.3` DMG and Sparkle update feed are verified
