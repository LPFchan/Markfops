...
- Next: push the `v1.0.0` tag to publish the first general-availability release
  - Owner: operator
  - Trigger: release packaging, signing, versioning, and the app icon are all verified on main
